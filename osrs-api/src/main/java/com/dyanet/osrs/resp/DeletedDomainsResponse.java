...
import static com.dyanet.osrs.OsrsConstants.KEY_DELETE_DATE;
import static com.dyanet.osrs.OsrsConstants.KEY_DELETE_DATE_EPOCH;
import static com.dyanet.osrs.OsrsConstants.KEY_DELETE_DOMAINS;
import static com.dyanet.osrs.OsrsConstants.KEY_EXPIRE_DATE;
import static com.dyanet.osrs.OsrsConstants.KEY_EXPIRE_DATE_EPOCH;
import static com.dyanet.osrs.OsrsConstants.KEY_NAME;
import static com.dyanet.osrs.OsrsConstants.KEY_PAGE_SIZE;
import static com.dyanet.osrs.OsrsConstants.KEY_REASON;
import static com.dyanet.osrs.OsrsConstants.KEY_TOTAL;
...
public class DeletedDomainsResponse extends OsrsResponse {
    ...
    /* (non-Javadoc)
     * @see com.dyanet.osrs.resp.OsrsResponse#populate(Map<String, String> attrMap, String level)
     */
    @Override
    ...
    private DeletedDomain createDeletedDomain(Map<String, String> attrMap2) throws ParseException {
        ...
        for (Iterator<String> it2 = attrMap2.keySet().iterator(); it2.hasNext();) {
            ...
            if (KEY_DELETE_DATE.equals(key)) {
                ...
                delDomain.setDeleteDateEpoch(Long.parseLong(attrMap2.get(key)));
                ...
                delDomain.setExpireDateEpoch(Long.parseLong(attrMap2.get(key)));
