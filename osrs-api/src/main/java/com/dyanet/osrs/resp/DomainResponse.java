...
import static com.dyanet.osrs.OsrsConstants.KEY_BELONGS_TO_RSP;
import static com.dyanet.osrs.OsrsConstants.KEY_DOMAIN_EXPIRY_DATE;
...
public class DomainResponse extends OsrsResponse {
  ...
  /* (non-Javadoc)
   * @see com.dyanet.osrs.resp.OsrsResponse#populate(Map<String, String> attrMap)
   */
  @Override
